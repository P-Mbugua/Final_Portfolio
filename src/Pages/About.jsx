                  ...
                  const processSteps = [
                    {
                      ...
                      moreDescription: "Think of this as creating the blueprint before building a house. We sit down to map out exactly who your customers are, what problems they face, and what success looks like for your business. By asking the right questions now, we ensure that every decision made later is intentional, saving you time and money by preventing costly changes down the road. You will walk away with a clear strategy that aligns perfectly with your vision.",
                      icon: (
                    ...
                    },
                    {
                      ...
                      moreDescription: "This is where we turn your ideas into a visual plan you can actually see and click through. Instead of imagining how the site will work, you will interact with a realistic model of it. We test the flow to make sure it feels intuitive for your users, fixing any confusing parts while it's still just a design. This step guarantees that when we start building, we are constructing something proven to work, eliminating the risk of building the wrong thing.",
                      icon: (
                    ...
                    },
                    {
                      ...
                      moreDescription: "This is the construction phase where the design comes to life. I write the code that powers your website, ensuring it looks stunning on every device, from large desktop monitors to small mobile phones. The focus here is on quality and speed; I build using modern standards that make your site load instantly and feel smooth to use. Just like a well-built car engine, the underlying code is clean and efficient, ensuring your site is easy to update and expand in the future.",
                      icon: (
                    ...
                    },
                    {
                      ...
                      moreDescription: "Before the world sees your new platform, we put it through a rigorous inspection. I test every button, link, and animation on all types of phones, tablets, and computers to ensure nothing breaks. We also check that the site loads quickly and is easy for everyone to use, including people with disabilities. This quality check ensures that your launch is smooth and professional, giving your users a flawless first impression that builds trust in your brand.",
                      icon: (
                    ...
                    },
                    {
                      ...
                      moreDescription: "This is your launch day. I handle all the technical setup to make your website live on the internet securely and correctly. But our partnership doesn't end there. A website is a living asset that needs care as your business grows. I provide ongoing support to monitor performance, keep security up to date, and help you add new features as your needs change. Think of me as a long-term partner dedicated to ensuring your digital presence continues to drive results for years to come.",
                      icon: (
                                  ...
                                  <div className="relative">
                                    ...
                                    <div className="space-y-16">
                                      {processSteps.map((item, index) => (
                                        <div 
                                          key={index}
                                          className="relative flex flex-col md:flex-row items-center gap-4 group"
                                        >
                                          ...
                                          <div className={`flex-1 w-full ${index % 2 === 0 ? 'md:text-right order-2 md:order-1' : 'hidden md:block order-1'}`}>
                                            <div className="group/card relative p-8 bg-zinc-900/40 backdrop-blur-xl rounded-2xl border border-zinc-800 hover:border-green-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_-10px_rgba(34,197,94,0.2)] overflow-hidden">
                                              ...
                                              <div className="relative z-10">
                                                ...
                                                <p className="text-justify text-gray-400 text-sm leading-relaxed">
                                          ...
                                          {/* Central Node (Icon) */}
                                          <div className="absolute left-8 md:left-1/2 -translate-x-1/2  w-6 h-6 bg-black border-1 border-green-500 rounded-full flex items-center justify-center z-20 shadow-[0_0_25px_rgba(34,197,94,0.4)] group-hover:scale-105 group-hover:shadow-[0_0_40px_rgba(34,197,94,0.6)] transition-all duration-500 order-1 md:order-2">
                                          ...
                                          <div className={`flex-1 w-full ${index % 2 === 0 ? 'hidden md:block order-3' : 'order-2 md:order-3'}`}>
                                            <div className="group/card relative p-6 bg-zinc-900/40 backdrop-blur-xl rounded-2xl border border-zinc-800 hover:border-green-500/50 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_40px_-10px_rgba(34,197,94,0.2)] overflow-hidden">
                                              <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 to-transparent opacity-0 group-hover/card:opacity-100 transition-opacity duration-500" />
