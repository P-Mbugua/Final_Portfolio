  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <button 
        ...
        className="fixed top-4 right-4 p-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-transform duration-300 z-30 hover:animate-bounceInOut"
      ...
      {!navOpen && (
        <div className="fixed top-0 right-0 h-full w-24 bg-gray-800 text-white flex items-center justify-center z-10">
          <p className="text-base font-bold transform -rotate-90 origin-bottom whitespace-nowrap">NAVIGATION BAR</p>
        </div>
      )}
    </div>
  );
